...
#chữ thứ 1
text.write("every problem is an oportunity, a jonrney of a thousand miles begins with the first step", font=("Apple Chancery", 30, "bold"), align="center")
